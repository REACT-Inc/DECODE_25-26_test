...
//
//@Autonomous(name = "OLD AUTO DONT USE ME! Auto", group = "Examples")
//public class ExampleOldAUTO extends OpMode {
//
...
//    private final Pose startPose = new Pose(70, 8, Math.toRadians(180)); // Start Pose of our robot.
...
//    private PathChain grabPickup1, scorePickup1, grabPickup2, scorePickup2, grabPickup3, scorePickup3, returnToBase;
//
...
//                .build();
//        //the path to return so less setup every tiem
...
////        shooter.init(hardwareMap, telemetryS);
//        buildPaths();
